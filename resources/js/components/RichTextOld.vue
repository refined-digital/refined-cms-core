...
<script>
  ...
  import ImageId from '../plugins/ckeditor/img/imageid'
  import CustomFigureAttributes from '../plugins/ckeditor/img/Image'
  // import { RefinedImage, RefinedImageParser } from '../plugins/ckeditor/NewImage'
  ...
  export default {
    ...
    created() {
      ...
      if (config.toolbar) {
        this.config.toolbar = config.toolbar;
      }

      if (config.fontSize) {
        this.config.fontSize = config.fontSize;
        if (!this.config.fontSize.options.includes('default')) {
          this.config.fontSize.options.push('default');
        }
      }
