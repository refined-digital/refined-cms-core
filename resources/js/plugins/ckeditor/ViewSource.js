...
export default class RefinedViewSource extends Plugin {
  init() {
    this.editor.ui.componentFactory.add('refined:view-source', locale => {
      ...
      view.set({
        ...
        icon: editIcon,
        tooltip: true,
        class: 'ck-button--view-source'
      });

      // Callback executed once the image is clicked.
      view.on('execute', () => {
        eventBus.$emit('rich-editor.view-source.toggle', { id: this.editor.id });
      });
