...
@endphp
        <div id="app" class="app__holder app__module--{{ $module }}" :class="{ 'app--has-media' : media.active || media.showModal, 'app--has-sitemap' : sitemap.active, 'app--has-link' : link.active }">
